...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/jquery-1.3.2/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/jquery-1.3.2/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/repertoire_faceting-0.3.4/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/repertoire_faceting-0.3.4/lib")
  ...
  @bundled_specs["jquery"] = eval(File.read("#{dir}/specifications/jquery-1.3.2.gemspec"))
  @bundled_specs["jquery"].loaded_from = "#{dir}/specifications/jquery-1.3.2.gemspec"
  @bundled_specs["repertoire_faceting"] = eval(File.read("#{dir}/specifications/repertoire_faceting-0.3.4.gemspec"))
  @bundled_specs["repertoire_faceting"].loaded_from = "#{dir}/specifications/repertoire_faceting-0.3.4.gemspec"
